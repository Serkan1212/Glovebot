...
**Davet Log Kanalı:**  ${davetlkanal} (${davetlog[guildID] == undefined ? "" : davetlog[guildID]}) `);
  ...
  if(["davetlog", "davetk", "davetkanal"].includes(args[0])) {
    if (!message.member.hasPermission("MANAGE_GUILD")) return message.channel.send("Gerekli izinlere sahip değilsiniz!");
