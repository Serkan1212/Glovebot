...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .setDescription('Sunucu [Burada](https://discord.gg/q6uHDVz) Tanıtıldı! \n\n 12 Saat Sonra Sunucunuzu Tekrardan Tanıtabilirsiniz. \n\n Sunucunu Tanıtabilmek İçin Beni [Ekle!](https://discordapp.com/oauth2/authorize?client_id=639861920970702911&scope=bot&permissions=805314622)')
  .setColor('GREEN')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('640234842683867146').send(embed)
            });
  ...
  message.channel.send({embed: {
      description: '**BAŞARISIZ TANITIM** \n\nBu komut zaten kullanılmış!\n\nSunucunu 12 saate 1 defa tanıtabilirsin! \n\n(https://discord.gg/KJ6faYU) \n[Discord Sunucumuz](https://discordapp.com/oauth2/authorize?client_id=525313553734041600&scope=bot&permissions=2146958847)'
            }});
  }
};
exports.conf = {
